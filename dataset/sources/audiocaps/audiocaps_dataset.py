...
class AudioCapsDataset(BaseDataset):
    """Load processed AudioCaps jsonl manifests."""

    _SPLIT_TO_FILE = {
        "train": "AudioCaps_train_AudioCaptioning.jsonl",
        "validation": "AudioCaps_validation_AudioCaptioning.jsonl",
        "test": "AudioCaps_test_AudioCaptioning.jsonl",
    }
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__("audiocaps", dataset_root, **kwargs)
